...
.outreachPriority{display:inline-flex;margin-top:7px;padding:5px 8px;border-radius:999px;font-size:9px;font-weight:900;letter-spacing:.08em;cursor:pointer;font-family:inherit}.outreachPriority.high{color:var(--green);border:1px solid rgba(105,240,181,.3);background:rgba(105,240,181,.09)}.outreachPriority.medium{color:var(--amber);border:1px solid rgba(255,209,102,.28);background:rgba(255,209,102,.08)}
